...
using Unity.VisualScripting; // Se incluye una biblioteca, pero no se utiliza en el código.
using UnityEngine;
using UnityEngine.SceneManagement;

public class MenuPausa : MonoBehaviour
{
    // GameObject del botón de pausa en el juego.
    ...
    public void Reanudar()
    {
        ...
        botonPausa.SetActive(true); // Activa el botón de pausa.
